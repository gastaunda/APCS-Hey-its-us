...
public class GameMovement extends JFrame {
	...
	public GameMovement() {
		...
		textArea1.setBackground(Color.BLUE); // makes it easier to see text in
												// demo

		textArea2 = new JTextArea(3, 10); // 3H x 10W
		textArea2.setEnabled(false);
		textArea2.setBackground(Color.BLUE); // makes it easier to see text in
												// demo
	...
	public static void main(String[] args) {
		GameMovement application = new GameMovement();
	}

	/******** PRIVATE INNER CLASSES FOR EVENT HANDLING ***************/
	/*
	 * - Provide MouseListener event handlers for mouse events - Provide
	 * KeyListener event handlers for key events
	 *
	 */
