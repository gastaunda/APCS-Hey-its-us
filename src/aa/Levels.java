...
public class Levels {
	...
	private void initialize() {
		...
		button_3.setBounds(531, 301, 199, 48);
		...
		button_4.setBounds(465, 180, 48, 48);
		frame.getContentPane().add(button_4);
		
		JButton button_5 = new JButton("5");
		button_5.setAction(action_5);
		button_5.setBounds(605, 180, 48, 48);
		frame.getContentPane().add(button_5);
		
		JButton button_6 = new JButton("6");
		button_6.setAction(action_6);
		button_6.setBounds(737, 180, 48, 48);
		frame.getContentPane().add(button_6);
		
		JButton button_7 = new JButton("7");
		button_7.setAction(action_7);
		button_7.setBounds(879, 180, 48, 48);
		frame.getContentPane().add(button_7);
		
		JButton button_8 = new JButton("8");
		button_8.setAction(action_8);
		button_8.setBounds(1042, 180, 48, 48);
